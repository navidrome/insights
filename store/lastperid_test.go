...
var _ = Describe("LastPerID", func() {
	...
	// A skipped line still occupies a position. If pass 1 stopped counting it, every winner
	// after it would be recorded one position early and pass 2 would yield the wrong lines.
